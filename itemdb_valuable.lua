    Accessory = {
        -- Phones
        { id = 1, name = "iPhone 17 Pro Max Оранжевый", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Legendary", fairPrice = 165000, spawnChance = 2 , economyProfile = "risky" }, 
        { id = 2, name = "iPhone 17 Pro Max Черный", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Legendary", fairPrice = 165000, spawnChance = 2 , economyProfile = "risky" }, 
        { id = 3, name = "iPhone 16", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Epic", fairPrice = 95000, spawnChance = 6 , economyProfile = "normal" }, 
        { id = 4, name = "Galaxy S24 Ultra", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Legendary", fairPrice = 138000, spawnChance = 3 , economyProfile = "risky" }, 
        { id = 5, name = "Galaxy S23+", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Epic", fairPrice = 78000, spawnChance = 10 , economyProfile = "normal" }, 
        { id = 6, name = "Galaxy A54 5G", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Rare", fairPrice = 35000, spawnChance = 22 , economyProfile = "safe" }, 
        { id = 7, name = "Galaxy A34", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Uncommon", fairPrice = 24000, spawnChance = 32 , economyProfile = "safe" }, 
        { id = 8, name = "Galaxy A14", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Common", fairPrice = 14000, spawnChance = 42 , economyProfile = "safe" }, 
        { id = 9, name = "Xiaomi 14 Ultra", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Epic", fairPrice = 88000, spawnChance = 8 , economyProfile = "normal" }, 
        { id = 10, name = "Redmi Note 13 Pro+", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Rare", fairPrice = 28000, spawnChance = 22 , economyProfile = "safe" }, 
        { id = 11, name = "Redmi 12", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Uncommon", fairPrice = 12000, spawnChance = 35 , economyProfile = "safe" }, 
        { id = 12, name = "POCO X5 Pro", accessoryType = "Phone", meshId = \"rbxassetid://18151141789\", rarity = "Common", fairPrice = 8500, spawnChance = 45 , economyProfile = "safe" }, 
        -- Common
        ...
        -- Uncommon
        { id = 76433144928129, name = "Balenciaga Black Beanie", meshId = \"rbxassetid://126092900954343\", accessoryType = "Hat", rarity = "Uncommon", fairPrice = 3800, spawnChance = 22 , economyProfile = "safe" }, 
        ...
        { id = 125022062433798, name = "Balenciaga Classic Cap Black", meshId = \"rbxassetid://18725278697\", accessoryType = "Hat", rarity = "Uncommon", fairPrice = 4200, spawnChance = 20 , economyProfile = "safe" }, 
        { id = 89806919638441, name = "Stone Island Черная Шапка", meshId = \"rbxassetid://125742269928594\", accessoryType = "Hat", rarity = "Uncommon", fairPrice = 5500, spawnChance = 16 , economyProfile = "safe" }, 
        ...
        { id = 85050284371929, name = "Balenciaga Black Scarf", meshId = \"rbxassetid://128873754438401\", accessoryType = "Neck", rarity = "Uncommon", fairPrice = 6200, spawnChance = 14 , economyProfile = "safe" }, 
        { id = 7495511289, name = "Nike Bucket Hat", accessoryType = "Hat", rarity = "Uncommon", fairPrice = 2800, spawnChance = 14 , economyProfile = "safe" }, 
        -- Rare
        { id = 139991202738079, name = "BENZO Bucket", meshId = \"rbxassetid://118892246906561\", accessoryType = "Hat", rarity = "Rare", fairPrice = 6800, spawnChance = 18 , economyProfile = "trap" }, 
        { id = 123136418672857, name = "CP Company Black Cap Luns", meshId = \"rbxassetid://135971255213262\", accessoryType = "Hat", rarity = "Rare", fairPrice = 6200, spawnChance = 15 , economyProfile = "safe" }, 
        { id = 100274668274911, name = "Balenciaga Loop Sports Beanie", meshId = \"rbxassetid://125670601578437\", accessoryType = "Hat", rarity = "Rare", fairPrice = 6800, spawnChance = 14 , economyProfile = "safe" }, 
        { id = 72865629988633, name = "Gucci Belt Bag", meshId = \"rbxassetid://109170456450250\", accessoryType = "Waist", rarity = "Rare", fairPrice = 9200, spawnChance = 12 , economyProfile = "safe" }, 
        { id = 98536965077473, name = "Stone Island Розовая Шапка", meshId = \"rbxassetid://125742269928594\", accessoryType = "Hat", rarity = "Rare", fairPrice = 7800, spawnChance = 12 , economyProfile = "safe" }, 
        { id = 80491609510625, name = "Stone Island Синюю Шапка", meshId = \"rbxassetid://125742269928594\", accessoryType = "Hat", rarity = "Rare", fairPrice = 7800, spawnChance = 12 , economyProfile = "safe" }, 
        { id = 118855002860927, name = "Moncler Beanie Black", meshId = \"rbxassetid://114745406160887\", accessoryType = "Hat", rarity = "Rare", fairPrice = 6500, spawnChance = 12 , economyProfile = "safe" }, 
        { id = 73941260210500, name = "Moncler Beanie White", meshId = \"rbxassetid://114745406160887\", accessoryType = "Hat", rarity = "Rare", fairPrice = 6500, spawnChance = 12 , economyProfile = "safe" }, 
        { id = 133709188535179, name = "Balenciaga White Cap", meshId = \"rbxassetid://102674254410492\", accessoryType = "Hat", rarity = "Rare", fairPrice = 8500, spawnChance = 10 , economyProfile = "safe" }, 
        { id = 130365225314391, name = "Balenciaga White Scarf", meshId = \"rbxassetid://128873754438401\", accessoryType = "Neck", rarity = "Rare", fairPrice = 8500, spawnChance = 10 , economyProfile = "safe" }, 
        { id = 109159521746706, name = "Vetements Огненная Кепка", meshId = \"rbxassetid://94337344600601\", accessoryType = "Hat", rarity = "Rare", fairPrice = 5200, spawnChance = 10 , economyProfile = "trap" }, 
        ...
        { id = 104262490921346, name = "Chrome Hearts Black Beanie", meshId = \"rbxassetid://120272448377408\", accessoryType = "Hat", rarity = "Rare", fairPrice = 12000, spawnChance = 3.5 , economyProfile = "safe" }, 
        -- Epic
